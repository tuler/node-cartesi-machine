...
- Stream outputs and reports as they are produced;
...
Now that we have a rollups machine and an input, we can advance the machine and collect the produced outputs and reports along the execution.
...
for (const event of machine.advance(input)) { // [!code focus]
    switch (event.type) { // [!code focus]
        case "output": // [!code focus]
            console.log(event); // [!code focus]
            break; // [!code focus]
        case "report": // [!code focus]
            console.log(event); // [!code focus]
            break; // [!code focus]
    } // [!code focus]
} // [!code focus]
